...
> This repository is a fork from orrsella's [cheatsheet repository](https://github.com/orrsella/soft-eng-interview-prep). I have added notes ragarding
> - even more basic data structures and algorithms knowledge
> - `Python` practical cases (original notes focus on `Java`)
